...
static uint8_t *conn_req_payload()
{
...
static uint8_t *conn_resp_payload()
{
...
static uint8_t *retr_req_payload()
{
...
static uint8_t *retr_resp_payload()
{
    /* RetrReq has no payload */
    return NULL;
}
...
static uint8_t *disc_req_payload(DiscReasonType discReason)
{
...
void conn_req_pdu(PDU_S* ret_pdu)
{
    ...
    ret_pdu->message_type = MSGT_CONNECTION_REQUEST;
    ret_pdu->receiver_id = RECEIVER_ID; /* TODO check*/
    ret_pdu->sender_id = SENDER_ID; /* TODO check */
    ret_pdu->sequence_number = 0;
    ret_pdu->confirmed_sequence_number = 0;
    ret_pdu->timestamp = 0;
    ret_pdu->confirmed_timestamp = 0;
    ret_pdu->payload = conn_req_payload();
...
void conn_resp_pdu(PDU_S *ret_pdu)
{
    ...
    ret_pdu->message_length = 50;
    ret_pdu->message_type = MSGT_CONNECTION_RESPONSE;
    ...
    ret_pdu->timestamp = 0;
    ret_pdu->confirmed_timestamp = 0;
    ret_pdu->payload = conn_resp_payload();
...
void retr_req_pdu(PDU_S *ret_pdu)
{
    ...
    ret_pdu->message_type = MSGT_RETRANSMISSION_REQUEST;
    ret_pdu->receiver_id = RECEIVER_ID;
    ret_pdu->sender_id = SENDER_ID;
    ret_pdu->sequence_number = 0;
    ret_pdu->confirmed_sequence_number = 0;
    ret_pdu->timestamp = 0;
    ret_pdu->confirmed_timestamp = 0;
    ret_pdu->payload = retr_req_payload();
...
void retr_resp_pdu(PDU_S *ret_pdu)
{
    ...
    ret_pdu->message_length = 36;
    ret_pdu->message_type = MSGT_RETRANSMISSION_RESPONSE;
    ret_pdu->receiver_id = RECEIVER_ID;
    ret_pdu->sender_id = SENDER_ID;
    ret_pdu->sequence_number = 0;
    ret_pdu->confirmed_sequence_number = 0;
    ret_pdu->timestamp = 0;
    ret_pdu->confirmed_timestamp = 0;
    ret_pdu->payload = retr_resp_payload();
...
void disc_req_pdu(DiscReasonType discReason, PDU_S *ret_pdu)
{
    ...
    ret_pdu->message_type = MSGT_DISCONNECTION_REQUEST;
    ret_pdu->receiver_id = RECEIVER_ID;
    ret_pdu->sender_id = SENDER_ID;
    ret_pdu->sequence_number = 0;
    ret_pdu->confirmed_sequence_number = 0;
    ret_pdu->timestamp = 0;
    ret_pdu->confirmed_timestamp = 0;
    ret_pdu->payload = disc_req_payload(discReason);
...
void hb_pdu(PDU_S *ret_pdu)
{
    ...
    ret_pdu->message_length = 36;
    ret_pdu->message_type = MSGT_HEARTBEAT;
    ret_pdu->receiver_id = RECEIVER_ID;
    ret_pdu->sender_id = SENDER_ID;
    ret_pdu->sequence_number = 0;
    ret_pdu->confirmed_sequence_number = 0;
